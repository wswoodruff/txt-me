...
module.exports = class TwilioService extends Schmervice.Service {
    ...
    // NOTE: Each Service can have no more than 400 phone numbers.
    ...
    async sendMms(from, to, body, mediaUrl) {
